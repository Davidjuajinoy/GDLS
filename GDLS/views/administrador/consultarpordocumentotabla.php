    ...
    <div class="container">
      ...
      <table class="table  table">
        ...
        <tbody>
          ...
          foreach($consultarmedianteDocumentoDos as $david):
          foreach($consultar_empleado_y_obtenerid as $j):
          ?>
          <tr>
            <td ><?php echo $david->nombres?></td>
            <td ><?php echo $david->apellidos?></td>
            <td ><?php echo $david->documento ?></td>
            <td ><?php echo $j->hora_entrada ?></td>
            <td ><?php echo $j->hora_salida ?></td>
            <td ><?php echo $j->fecha ?></td>
            <td ><?php echo $david->correo ?></td>
